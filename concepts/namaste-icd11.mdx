---
title: "Understanding NAMASTE and ICD-11 Code Mapping"
...
The same NAMASTE code can also target the Biomedicine chapter — for example, `NAM-011` (Arsha — piles/haemorrhoids) maps to `BM-001` with a confidence of `0.87`.
