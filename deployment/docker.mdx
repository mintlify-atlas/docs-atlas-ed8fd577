---
title: "Deploy Ayush Synapse with Docker Compose"
sidebarTitle: "Docker"
description: "Build and run Ayush Synapse using Docker Compose for cloud or on-premise deployments with environment variable configuration."
---
...
<Note>
  **Prerequisites** — Make sure the following are installed on your host machine:
  ...
  - [Docker Compose v2](https://docs.docker.com/compose/install/) (`docker compose` CLI, not the legacy `docker-compose` v1)
</Note>
