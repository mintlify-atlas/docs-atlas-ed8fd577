---
title: "Run Ayush Synapse Locally with Python"
sidebarTitle: "Local Setup"
description: "Set up and run Ayush Synapse on your local machine with Python 3.8+, a virtual environment, and SQLite for development."
---
